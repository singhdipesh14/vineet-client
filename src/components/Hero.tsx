			...
			<Right>
				<Info>
					...
					<P color="--dark-color" className="info">
						...
						suscipit cupiditate quisquam, iste deleniti veniam, sequi ad perspiciatis
						mollitia ex sed numquam, quas consequatur atque illum? Quisquam dicta
						earum veritatis nihil enim dolor, expedita ipsam totam aut harum quam!
					</P>
					<Button to="/about" darkColor="--dark-color" lightColor="--light-color">
						About me
					</Button>
				</Info>
			</Right>
